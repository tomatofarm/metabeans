...
**작성일**: 2026-02-13  
**근거 문서** (우선순위순):
1. MQTT Payload 규격_260212.pdf (2026-02-12, **최우선**)
2. ESP 관리툴_최종피드백_260212.pdf (2026-02-12, **최우선**)
3. MetaBeans_ESP_데이터구조_정의서_v2.0.md (참조용)
4. MetaBeans_ESP_관리툴_전체구조_기획서.docx (참조용)
      ...
      "controllers": [
        {
          ...
          "fan_speed": 2, "flow": 850.0, "damper": 75.0,
...
| fan_speed | INT | - | 팬 속도 단계 (0=OFF, 1=LOW, 2=MID, 3=HIGH) |
...
| target_flow | FLOAT | | 수동 목표 풍량 (CMH) |
...
| equipment_id | BIGINT (FK → equipment) | ✅ | 대상 장비 |
| spark_threshold | INT DEFAULT 70 | | 스파크 기준값 (0~99) |
...
*본 문서는 MQTT Payload 규격_260212.pdf와 ESP 관리툴_최종피드백_260212.pdf를 최우선 근거로 작성되었습니다. 개발 진행에 따라 변경될 수 있습니다.*
