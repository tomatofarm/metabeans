# MetaBeans ESP — MQTT 통신 프로토콜 설계서 v2.0

> **프롬프트 D-1**: MQTT Payload 처리 및 백엔드 연동  
> **작성일**: 2026-02-13  
> **최종 업데이트**: 2026-02-13 (v2.0)  
> **근거 문서**: MQTT_Payload_규격_260213.pdf, MQTT_토픽_구조_변경_및_협의_사항.pdf, ESP_관리툴_최종피드백_260212.pdf, MetaBeans_ESP_데이터구조_정의서_v3_0.md, MetaBeans_ESP_프로젝트_아키텍처_기술스택_정의서.md
...
const ControllerDataSchema = z.object({
  ...
  fan_mode: z.number().int().min(0).max(1),       // v2.0 추가
  damper_mode: z.number().int().min(0).max(1),     // v2.0 추가
  flow: z.number(),
...
CREATE TABLE controller_sensor_data (
    ...
    fan_speed INT,
    fan_mode INT DEFAULT 0,          -- v2.0 추가
    damper_mode INT DEFAULT 0,       -- v2.0 추가
...
*본 문서는 MQTT_Payload_규격_260213.pdf, MQTT_토픽_구조_변경_및_협의_사항.pdf, ESP_관리툴_최종피드백_260212.pdf, MetaBeans_ESP_데이터구조_정의서_v3_0.md, MetaBeans_ESP_프로젝트_아키텍처_기술스택_정의서.md를 기반으로 작성되었습니다.*
