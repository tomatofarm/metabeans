  ...
  const columns: ColumnsType<SystemUserItem> = [
    ...
    },
    {
      ...
      render: (status: AccountStatus) => (
        <Tag color={ACCOUNT_STATUS_CONFIG[status]?.color}>
          {ACCOUNT_STATUS_CONFIG[status]?.label ?? status}
        </Tag>
      ),
    },
    {
                  ...
                  >
                    <Checkbox
                      ...
                      style={{
                        ...
                        color: override ? '#1890ff' : undefined,
                      }}
                    >
                      <Text style={{ color: override ? '#1890ff' : undefined }}>
