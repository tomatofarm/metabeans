...
import { registerAdmin, checkLoginId } from '../../../api/auth.api';
...
const STEPS = [{ title: '기본 정보' }, { title: '약관 동의' }];
...
export default function AdminRegisterPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      navigate('/register/complete', { state: { role: 'ADMIN' } });
    } catch {
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <Text type="secondary">메타빈스 본사 운영 직원</Text>
        </div>
